...
BOOST_PYTHON_MODULE( pyhector )
{
  ...
  py::class_<Hector::Beamline>( "Beamline", "A collection of elements composing a beamline" )
    ...
    .add_property( "interactionPoint", py::make_function( &Hector::Beamline::interactionPoint, py::return_value_policy<py::return_by_value>() ), &Hector::Beamline::setInteractionPoint, "Bunch crossing element (place where collisions occur)" )
