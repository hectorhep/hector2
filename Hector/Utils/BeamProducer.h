  ...
  namespace BeamProducer
  {
    ...
    class ParticleGun
    {
      public:
        ...
        Particle shoot() {
          StateVector vec;
          const float s = rngs_[0]( gen_ ), x = rngs_[1]( gen_ ), y = rngs_[2]( gen_ ),
                      tx = rngs_[3]( gen_ ), ty = rngs_[4]( gen_ ), e = rngs_[5]( gen_ );
